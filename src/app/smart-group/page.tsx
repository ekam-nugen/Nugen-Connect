    ...
    return (
        <div className='bg-white flex flex-col items-center rounded-3xl p-8'>
            ...
            <div className="flex flex-col items-center w-1/2 py-8">
                <div className="text-3xl font-bold text-[#3f4648]">Not ordinary groups. Meet Smart Groups.</div>
                <div className="text-sm text-center pt-3 pb-6">Smart Groups allow you to segment users into groups that update automatically according to roles, branches, qualifications, or anything else you need to maximize operational efficiency.</div>
