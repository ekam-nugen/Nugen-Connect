// import { QuickServicesDataType } from "@/components/QuickServices/interface";
// import { AccessControlListPropType, STATUS } from "../../../types/index";
// import { SubItem } from "@/components/QuickServices/showList/types";
// import { checkInTableType } from "@/components/checkInModal";
...
//   title: string;
//   sortable?: boolean;
//   isVisible?: (data: SubItem[]) => boolean;
//   cell?: ({
//     row,
//     getValue,
//     setFunction,
...
//     getValue: () => any;
//     setFunction: (val: checkInTableType[]) => void;
//     prevValue: checkInTableType[];
//     roomId?: string;
//   }) => React.ReactNode;
// };
...
//   onEditClick?: (
//     data: RoomApiDataProps | AccessControlListPropType | SubItem
//   ) => void | Promise<void>;
//   onAddOrder?: (
//     data: RoomApiDataProps | AccessControlListPropType | SubItem
//   ) => void | Promise<void>;
...
//   onChangeTableValues?: (val: checkInTableType[]) => void;
//   tableValue?: checkInTableType[];
