    ...
    return (
        <div className='bg-white flex flex-col items-center rounded-3xl p-8'>
            ...
            <div className="flex flex-col items-center w-3/5 py-8">
                <div className="text-3xl font-bold text-[#3f4648]">Get Started with Events</div>
                <div className="text-sm text-center pt-3 pb-6 w-3/4">Create a beautiful agenda of all company events, make it simple for users to access
                    event's details and mark their attendance, and bring people together effortlessly</div>
            ...
            <p className='text-xl font-bold text-[#3f4648] py-8'>Fully packed, out of the box</p>
